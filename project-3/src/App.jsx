  ...
  return (
    <div className="min-h-screen  bg-gradient-to-br from-gray-900 via-black to-gray-800 flex flex-col md:flex-row  items-center justify-center">
      ...
      <form
        ...
        className="flex flex-col mt-3 md:flex-row justify-between items-center w-full md:w-3/5 h-5/6 
            ...
            return (
              ...
              >
                <div>
                  ...
                  <p className="p-2 font-semibold text-gray-500  break-all text-xs opacity-90 leading-tight">
                    {elem.detail}
                  </p>
                </div>
                <button
